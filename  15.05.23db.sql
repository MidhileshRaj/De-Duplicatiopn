...
(4,'\"++\"',0,'2023-05-15','pending','pending');
...
(11,'adinant@gmail.com','987654321','teacher');
...
insert  into `student_upload`(`upload_id`,`assignment_id`,`file_name`,`date`,`student_id`) values 
(1,0,'\"++\"',20230515,0);
...
(8,11,'adinan','male',9878456123,'pannayanur','chokli',670671,'adinant@gmail.com','/static/teacher/20230511-130442.jpg',3,'pending');
